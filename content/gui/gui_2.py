...
frame_header = tk.Frame(window, borderwidth=2, pady=2, bg = "black")
frame_header.grid(row=0, column=0)
label_header = tk.Label(frame_header, text = "Woo penguins", bg='white', fg='black', height=2, width = 35, font=("Helvetica 16 bold"))
label_header.grid(row=0, column=0)

frame_center = tk.Frame(window, borderwidth=2, pady=2, bg = "black")
frame_center.grid(row=1, column=0)

frame_bottom = tk.Frame(window, borderwidth=2, pady=2, bg = "black")
...
frame_main_1 = tk.Frame(frame_center, borderwidth=2, relief='sunken')
frame_main_2 = tk.Frame(frame_center, borderwidth=2, relief='sunken')
frame_main_3 = tk.Frame(frame_center, borderwidth=2, relief='sunken')

var1_label = tk.Label(frame_main_1, text = "Island: ")
var2_label = tk.Label(frame_main_2, text = "Body Mass (g): ")
var3_label = tk.Label(frame_main_3, text = "Culmen Length (mm): ")
...
frame_answer = tk.Frame(frame_bottom, borderwidth=2, relief='sunken')
...
var1 = tk.StringVar()
var1_entry = tk.OptionMenu(frame_main_1, var1, "Torgersen", "Biscoe", "Dream")
var1_entry.pack(side='right', padx=1)

var2 = tk.StringVar()
var2_entry = tk.Entry(frame_main_2, textvariable = var2, width=10)
var2_entry.pack(side='right', padx=1)

var3 = tk.StringVar()
var3_entry = tk.Entry(frame_main_3, textvariable = var3, width=10)
...
# We'll comment this out next lecture
answer_label = tk.Label(frame_answer, font=('arial', 16, 'bold'), bd=16, anchor="w", textvariable=var1)   
